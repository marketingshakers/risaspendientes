...
const Hero = () => (
  <div className="bg-x-yellow-500">
    <div className="flex py-32 c-lg sm:py-0" style={{ minHeight: '90vh' }}>
      <div className="flex flex-wrap-reverse my-auto w-full items-center sm:flex-wrap">
        <div className="w-full sm:w-1/2">
          ...
          >
            <h1
              className="font-bold font-title animate text-x-blue-500 text-5xl lg:text-6xl"
            >
              Risas Pendientes
            </h1>
            <p
              className="font-title pl-px mt-2 text-xl animate text-x-gray-500 sm:text-2xl"
